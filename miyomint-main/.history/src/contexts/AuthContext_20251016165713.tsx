  ...
  const signIn = async (email: string, password: string) => {
    try {
      ...
      if (error) {
        ...
        // 406 veya benzeri hata mesajlarını özel göster
        if (error.status === 406) {
          return { error: { message: "Sunucu isteği reddetti (406). Lütfen e-posta/şifre ve Supabase ayarlarını kontrol edin.", name: "NotAcceptable", status: 406 } };
        }
