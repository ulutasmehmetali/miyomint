...
function AppContent() {
  ...
  // 💳 Kullanıcı login değilse checkout modal aç
  ...
  // ✅ Misafir ödeme akışı (popup yerine yönlendirme sayfası)
  const handleGuestCheckout = () => {
    // Modal ve sepeti tamamen kapat
    setCheckoutModalOpen(false);
    setCartOpen(false);

    // Küçük gecikme → animasyon düzgün çalışsın
    setTimeout(() => {
      setCurrentPage("guestRedirect");
    }, 300);
  };

  // 🧾 Sipariş oluşturma (login kullanıcı için)
