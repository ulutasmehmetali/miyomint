...
export default function GuestCheckoutPage({
  ...
  // 🟩 STEP 3 ekranını VerifyPage tarzında modern göstereceğiz
  if (step === 3) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 to-white text-center animate-fade-in">
        <div className="bg-white p-10 rounded-2xl shadow-2xl max-w-lg border border-teal-100">
          <CheckCircle className="w-16 h-16 text-teal-600 mx-auto mb-4 animate-bounce" />
          <h1 className="text-2xl font-bold text-gray-800 mb-2">
            Siparişiniz Alındı 🎉
          </h1>
          <p className="text-gray-600 mb-4">
            Ödemeniz başarıyla alındı. Sipariş detayları e-posta adresinize
            gönderildi.
          </p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-8">
        {/* SOL TARAF: Form veya ödeme ekranı */}
