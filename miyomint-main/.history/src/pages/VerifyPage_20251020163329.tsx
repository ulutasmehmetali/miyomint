    ...
    const verifySession = async () => {
      try {
        ...
        if (code && !access_token) {
          console.log("🔐 PKCE kodu bulundu, session oluşturuluyor...");
          ...
          console.log("✅ PKCE oturumu başarıyla alındı:", data.session.user?.email);
        }

        // 🔹 2️⃣ Eski token bazlı doğrulama (geri uyumluluk)
          ...
          console.warn("⚠️ Ne PKCE kodu ne token bulundu.");
        }
