...
if (error) console.error("🔴 Supabase setSession error detay:", error);
if (!data) console.warn("⚠️ Supabase hiç yanıt dönmedi, bağlantı mı kesik?");

    console.log("🔍 setSession yanıtı:", { data, error }); // 👈 BU SATIRI EKLE
