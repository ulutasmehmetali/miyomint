...
export default function VerifyPage() {
  ...
  // ✅ E-postayı yeniden gönderme işlemi
  const resendVerification = async () => {
    if (!email) {
      alert("E-posta adresi bulunamadı. Lütfen yeniden giriş yapın.");
      return;
    }
    setResending(true);
    try {
      ...
      if (error) {
        ...
        toast.success("Yeni doğrulama bağlantısı e-posta adresine gönderildi ✅");
      }
    } finally {
      setResending(false);
    }
