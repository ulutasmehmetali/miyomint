...
export default function VerifyPage() {
  ...
  useEffect(() => {
    const verifySession = async () => {
      try {
        // ✅ URL parametrelerini hem hash hem search’ten yakala
        ...
        // ✅ signup için verifyOtp kaldırıldı, direkt setSession çalışacak
        ...
        if (sessionError) {
          console.error("❌ setSession:", sessionError.message);
        ...
        // ✅ Profil tablosunda email_verified güncelle
        ...
        if (!profile) {
          try {
            ...
            console.error("⚠️ Profil oluşturulamadı:", profileCreateError);
          }
        } else {
