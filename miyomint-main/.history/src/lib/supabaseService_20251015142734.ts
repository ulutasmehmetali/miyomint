...
export const supabaseService = {
  ...
  // 🛒 SEPET — GETİR (Giriş yapmış kullanıcı)
  ...
  // 🛒 SEPET — ÜRÜN EKLE (Giriş yapmış kullanıcı)
  ...
  // 💳 SİPARİŞ — KAYDET (giriş yapmış kullanıcı)
  ...
  // 💳 SİPARİŞ — GETİR (giriş yapmış kullanıcı)
  ...
  // 🛒 Misafir sepetine ürün ekle (guest_cart_items tablosu)
  ...
  // 🧾 Misafir sepetini getir (guest_cart_items tablosundan)
  ...
  // 🧹 Misafir sepetini temizle (checkout sonrası)
