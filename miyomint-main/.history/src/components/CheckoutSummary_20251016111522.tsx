...
export default function CheckoutSummary({ items, onCheckout }: CheckoutSummaryProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 space-y-4 animate-fadeIn">
      ...
      <button
        onClick={onCheckout}
        className="w-full bg-gradient-to-r from-teal-500 to-teal-600 text-white py-3 rounded-xl font-semibold shadow-md hover:from-teal-600 hover:to-teal-700 transition-all duration-300 active:scale-95"
      >
        Siparişi Tamamla
      </button>
