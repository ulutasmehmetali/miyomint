...
import { Product, PageKey } from "../types";
import { products, benefits } from "../data/products";
import ProductCard from "../components/ProductCard";

interface HomePageProps {
  onAddToCart: (product: Product) => Promise<void>; // 🔹 async düzeltme
  onBuyNow: (product: Product) => Promise<void>; // 🔹 async düzeltme
      ...
      <section className="relative bg-gradient-to-br from-white via-teal-50/30 to-white py-16 sm:py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="animate-slide-up text-center lg:text-left px-2 sm:px-0">
              <div className="inline-flex items-center gap-2 bg-teal-100 text-teal-700 px-4 py-2 rounded-full text-sm font-medium mb-6 mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center sm:items-stretch justify-center lg:justify-start">
                <button
                  onClick={() => onNavigate("products")}
                  className="w-full sm:w-auto bg-gradient-to-r from-teal-500 to-teal-600 text-white px-8 py-4 rounded-xl font-semibold hover:from-teal-600 hover:to-teal-700 transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:scale-105 relative overflow-hidden group"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-white text-teal-600 px-8 py-4 rounded-xl font-semibold border-2 border-teal-600 hover:bg-teal-50 transition-all duration-300 transform hover:scale-105 hover:border-teal-700 hover:shadow-lg"
                >
                  Daha Fazla Bilgi
                </button>
              </div>

              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 mt-10 sm:mt-12">
            ...
            <div
              className="relative animate-slide-up w-full max-w-xl mx-auto lg:mx-0 lg:max-w-none mt-12 lg:mt-0"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="text-center p-5 sm:p-6 bg-gradient-to-br from-gray-50 to-white rounded-xl hover:from-teal-50 hover:to-teal-100 transition-all duration-300 transform lg:hover:scale-105 lg:hover:shadow-lg border border-gray-100 lg:hover:border-teal-200"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-teal-500 to-teal-600 rounded-3xl overflow-hidden shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <button
                  onClick={() => onNavigate("products")}
                  className="mt-8 w-full sm:w-auto bg-white text-teal-600 px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Hemen Sipariş Ver
                </button>
              </div>

              <div className="relative h-full min-h-[280px] sm:min-h-[360px] lg:min-h-[600px]">
                <img
                  src="/image.png"
            ...
            {[
              {
                ...
                initials: "AY",
                city: "İstanbul",
                text: "MiyoMint'i kullanmaya başladığımdan beri evimde hiç kedi kumu kokusu kalmıyor.",
              },
              {
                name: "Mehmet Kaya",
                initials: "MK",
                city: "Ankara",
                text: "3 kedim var ve hepsinin kumlarına kullanıyorum. Kimyasal içermediği için gönül rahatlığıyla kullanabiliyorum.",
              },
              {
                name: "Zeynep Öztürk",
                initials: "ZÖ",
                city: "İzmir",
                text: "Daha önce parfümlü ürünler kullanıyordum ama kedim rahatsız oluyordu. MiyoMint tamamen kokusuz ve çok etkili.",
              },
            ].map((review, i) => (
              <div
                key={i}
