import { ShoppingCart, Menu, X, User, LogOut, Settings, Package, MessageCircle } from 'lucide-react';
...
export default function Header({ currentPage, onNavigate, cartItemCount, onCartClick, onLoginClick }: HeaderProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <span className="text-xl font-bold bg-gradient-to-r from-teal-600 to-teal-700 bg-clip-text text-transparent">MiyoMint</span>
          </button>
