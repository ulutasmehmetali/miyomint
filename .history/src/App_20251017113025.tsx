...
import VerifyPage from "./pages/VerifyPage"; // ✅ EKLENDİ
...
function AppContent() {
  ...
  // 🧩 Sayfa açıldığında doğrulama linkini kontrol et
  useEffect(() => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case "products":
        return (
          <ProductsPage onAddToCart={handleAddToCart} onBuyNow={handleBuyNow} />
        );
      case "faq":
        return <FAQPage />;
      case "about":
