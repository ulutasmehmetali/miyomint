    ...
    try {
      ...
      const { data, error } = await supabase.auth.signUp({
        ...
        options: {
          ...
          emailRedirectTo: "https://miyomint.com.tr/#verify=",
        },
      });

      if (error) throw error;

      // 🔹 2. Ek tabloya kayıt (opsiyonel)
      if (data.user) {
      ...
      else setError("Kayıt oluşturulurken bir hata oluştu.");
    } finally {
      setLoading(false);
    }
  };
            ...
            {success && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3">
                ...
                <div className="text-sm text-green-800">
                  ...
                  <p>
                    Lütfen e-posta adresinizi kontrol edip doğrulama linkine
                    tıklayın.
                  </p>
                </div>
              </div>
