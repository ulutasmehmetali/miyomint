...
export default function SignupModal({ isOpen, onClose, onSwitchToLogin }: SignupModalProps) {
  ...
  // ✳️ Şifre kuralları: en az 6 karakter, 1 büyük harf, 1 rakam
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 🌐 Ortama göre yönlendirme URL’si
      const redirectUrl = window.location.origin.includes("localhost")
        ? "http://localhost:5173/#verify="
        : "https://miyomint.com.tr/#verify=";

      // ✅ 1️⃣ Supabase üzerinden kullanıcı oluştur
      ...
      // ✅ 2️⃣ (Opsiyonel) kullanıcıyı users tablosuna ekle
      if (data.user) {
            ...
            {success && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3">
                ...
                <div className="text-sm text-green-800">
                  ...
                  <p>
                    Lütfen e-posta adresinizi kontrol edip doğrulama linkine tıklayın.
                  </p>
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
                  placeholder="En az 6 karakter, 1 büyük harf, 1 rakam"
                />
              </div>
            </div>
