...
import VerifyPage from "./pages/VerifyPage"; // ✅ doğrulama sayfası
...
function AppContent() {
  ...
  // ✅ Eğer URL #verify=TOKEN içeriyorsa otomatik doğrulama sayfasına yönlendir
  useEffect(() => {
  ...
  // ✅ Yeni sayfayı switch-case'e ekledik
  const renderPage = () => {
    switch (currentPage) {
      case "home":
        return (
