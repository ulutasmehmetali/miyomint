...
import VerifyPage from "./pages/VerifyPage"; // ✅ E-posta doğrulama sayfası
...
function AppContent() {
  ...
  // ✅ Eğer URL #verify=TOKEN içeriyorsa, doğrulama sayfasına yönlendir
  useEffect(() => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case "products":
        return <ProductsPage onAddToCart={handleAddToCart} onBuyNow={handleAddToCart} />;
      case "faq":
        return <FAQPage />;
      case "about":
        return <AboutPage />;
      ...
      case "verify":
        return <VerifyPage />;
      default:
        return <HomePage onAddToCart={handleAddToCart} onBuyNow={handleAddToCart} onNavigate={handleNavigate} />;
    }
  };
