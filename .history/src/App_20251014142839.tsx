...
const handleGuestCheckout = () => {
  ...
  // 💬 Bilgilendirme mesajı (debug veya kullanıcıyı bilgilendirme amaçlı)
  alert("Misafir olarak devam ediyorsunuz. Lütfen teslimat bilgilerinizi girin.");

  // 🔄 Misafir ödeme sayfasına yönlendir
