        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                num: 1,
                title: "Temiz Kum Kullanın",
                text: "Kedi kum kabınızı temizleyin ve temiz kum kullanın",
              },
              {
                num: 2,
                title: "MiyoMint Serpin ve Karıştırın",
                text: "3 yemek kaşığı kadar MiyoMint'i kumun üzerine serpip karıştırın",
              },
              {
                num: 3,
                title: "Ferahlık Yaşayın",
                text: "Evinizin ferah kalmasının tadını çıkarın. Her kum değişiminde tekrarlayın",
              },
            ].map((step) => (
              <div
                key={step.num}
                className="bg-white rounded-2xl p-8 border-2 border-teal-200 shadow-lg h-full text-center"
              >
              ...
              {[
                {
                  ...
                  desc: "Ürünümüzden memnun kalmazsanız parayınızı iade ediyoruz",
                },
                {
                  icon: <Shield className="w-8 h-8 text-teal-600" />,
                  title: "Güvenli Alışveriş",
                  desc: "Kart bilgileriniz SSL sertifikası ile korunur",
                },
                {
                  icon: <Heart className="w-8 h-8 text-teal-600" />,
                  title: "Ücretsiz Kargo",
                  desc: "Tüm Türkiye'ye 2-3 iş günü içinde teslimat",
                },
              ].map((item, i) => (
                <div key={i}>
